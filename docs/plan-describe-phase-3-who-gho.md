...
Запрещено коммитить реализацию без предшествующего теста. Тесты на describe-инструменты проверяют: status=ok, количество countries, диапазон years, sexes/agegroups/severities, total_records.
